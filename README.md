...
| 문서 | 내용 |
| --- | --- |
| [docs/CODING_QUIZ_FCM_TEST.md](./docs/CODING_QUIZ_FCM_TEST.md) | 로컬에서 `/fcm-test`로 알림 서버 FCM 발송을 확인하는 실행 절차 |
| [docs/FCM_TEST_CODE_OVERVIEW.md](./docs/FCM_TEST_CODE_OVERVIEW.md) | Coding_Quiz에 추가된 FCM 테스트 코드 위치와 역할 |
| [docs/FCM_CONSOLE_SETUP.md](./docs/FCM_CONSOLE_SETUP.md) | Firebase Console에서 Web app, VAPID key, service account를 준비하는 방법 |
| [docs/NOTIFICATION_PROJECT_INTEGRATION_GUIDE.md](./docs/NOTIFICATION_PROJECT_INTEGRATION_GUIDE.md) | 실제 서비스 프로젝트가 notification-be에 붙을 때의 역할 분리 |
| [docs/NOTIFICATION_BE_MEETING_NOTES.md](./docs/NOTIFICATION_BE_MEETING_NOTES.md) | 테스트 중 확인한 notification-be 쪽 논의 안건 |
...
```text
1. README.md
2. docs/CODING_QUIZ_FCM_TEST.md
3. docs/FCM_TEST_CODE_OVERVIEW.md
4. docs/FCM_CONSOLE_SETUP.md
5. docs/NOTIFICATION_PROJECT_INTEGRATION_GUIDE.md
6. docs/NOTIFICATION_BE_MEETING_NOTES.md
```
...
자세한 실행 절차는 [docs/CODING_QUIZ_FCM_TEST.md](./docs/CODING_QUIZ_FCM_TEST.md)를 봅니다.
